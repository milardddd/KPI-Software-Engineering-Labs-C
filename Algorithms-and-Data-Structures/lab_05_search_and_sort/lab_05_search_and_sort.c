 ...
 * Laboratory Work #5
 * Topic: Search Algorithms & Sequence Processing
 *
 * Author: Timofii Rybalko
 * Created: 11/2025
 *
 * Description:
 * Implementation of intersection logic between two sequences and
 * comparison of search techniques: Linear Search vs. Binary Search.
 * Includes Bubble Sort as a prerequisite for the Binary Search algorithm.
 */
...
int main() {
  ...
  if (binary_pos != -1) {
    printf(
        "2. Бінарний пошук: Число %d знайдено. Позиція (у відсортованому "
        "масиві): %d\n",
