 ...
 * Laboratory Work #6
 * Topic: Sequence Sorting Algorithms (Matrix Processing)
 *
 * Author: Timofii Rybalko
 * Created: 11/2025
 *
 * Description:
 * Advanced matrix manipulation and implementation of the Shell Sort algorithm.
 * Tasks:
 * 1. Calculate row-wise averages of negative elements (Array B).
 * 2. Sort matrix columns in descending order using the Shell Sort gap-sequence
 * method.
 */
